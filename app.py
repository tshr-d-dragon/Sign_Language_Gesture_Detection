...
densenet = load_model('Gesture/model_weights/Gesture_DenseNet121.h5')
...
def prediction():
    ...
    image.save(f'Gesture/Predicted_Images/img_{dt_string}.jpg')

    img = cv2.imread(f'Gesture/Predicted_Images/img_{dt_string}.jpg')
    ...
    label_save_file = open('Gesture/Predicted_Images/label_save.txt', 'a')
